      ...
      <div className="container">
        ...
        <div className={styles.wrap}>
          ...
          <div className={`card card-pad ${styles.disclaimer}`}>
            <h2>데이터 출처와 면책</h2>
            <p>본 서비스가 사용하는 데이터는 다음 국내 공개 자료를 참고했습니다.</p>
            <ul className={styles.sourceList}>
              <li>
                <strong>지역별 일사량/발전시간</strong> — 기상청 월별 수평면 일사량
                평년값, 한국에너지공단 신·재생에너지 자원지도 (대표값)
              </li>
              <li>
                <strong>과거 태양광 발전량 추이</strong> — 한국에너지공단 신·재생에너지
            ...
            <p>
              위 값은 공개 자료를 참고해 정리한 <strong>대표값·근사치</strong>이며
              학습용 데모를 위해 단순화되었습니다. 본 서비스가 제시하는 발전량·수익·
              회수기간은 어떠한 경우에도 실제 사업 수익을 보장하지 않습니다. 실제
              투자 결정 전에는 부지별 정밀 일사량 측정, 계통 연계 조건, 최신 SMP·REC
              시세, 인허가 비용 등을 반영한 전문가 검토가 반드시 필요하며, 정밀
              분석에는 공공데이터포털·기상청 기상자료개방포털·KOSIS 등의 원자료를
              사용해야 합니다.
            </p>
          </div>
        </div>
