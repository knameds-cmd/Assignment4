 ...
 * 못하는" 비율(0~1)이다. 전력거래소(KPX) 비중앙 출력제어 정보와 공표 통계
 * (제주 출력제한 2023년 181회 등, 최근 실적 한 자릿수%대)를 참고해, 제주는
 * 높게(약 5%), 태양광이 밀집해 2024년부터 육지 출력제어가 시작된 호남권은
 * 낮게(약 2%), 그 외 지역은 0으로 둔다. 시뮬레이터에서 직접 조정할 수 있다.
 *
